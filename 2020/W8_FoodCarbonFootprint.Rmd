...
```{r}
tern_plot <- Tricolore(diet, "Dairy", "Meat_and_Fish",
...
diet_plot <- diet %>% 
  ...
  labs(title = "CO2 footprints by food category",
       subtitle = "Discrepancy of food category is noticeable between continents ",
       caption = "Source: nu3 | Graphic: Sung Inkyung") +
...
ggsave(here("2020", "W8_ContinentsFoodCo2.png"), width = 28, height = 24, units = "cm")
```
