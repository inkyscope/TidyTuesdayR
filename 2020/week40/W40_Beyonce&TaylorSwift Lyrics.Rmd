...
plot <- emotions %>% 
  ...
  theme(legend.position = "none",
        ...
        plot.title = element_text(family = "Rajdhani",
                                  size = 13,
                                  hjust = 0.5),
        axis.title.x = element_text(family = "Poppins", 
                                    size = 7),
        axis.text = element_text(family = "Rajdhani",
                                 size = 8),
        panel.spacing = unit(1.2, "lines"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank())

ggsave("W40_Beyonce&TalyorSwiftLyrics.png", width = 15, height = 11, units = "cm")
```
