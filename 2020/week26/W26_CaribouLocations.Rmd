...
plot <- tracks %>% 
  ...
  theme(legend.position = c(.55, .3),
        legend.text = element_text(color = "#cee5ce",
                                   family = "Lexend",
                                   size = 11),
        legend.title = element_text(color = "#cee5ce",
                                    family = "Lexend",
                                    size = 14,),
        panel.spacing.x = unit(3, "lines"),
        plot.background = element_rect(fill = "#a2a287",
                                       color = NA),
        strip.text = element_text(color = "#272c67",
                                  family = "Lexend",
                                  size = 18),
        plot.title = element_text(color = "white",
                                  ...
                                  face = "bold",
                                  margin = margin(b = 20)),
        plot.caption = element_text(color = "gray85",
                                    family = "BenchNine",
                                    size = 11,
                                    hjust = .5,
                                    margin = margin(t = 30)),
...
ggsave("W26_CaribouLocations.png", width = 23, height = 21, units = "cm")
