---
title: "W33 Avatar-The Last Airbender"
author: "Sung Inkyung"
date: '2020 8 15 '
...
plot_tile <- df %>% 
  ...
  labs(x = "Chapter Numbers",
       y = "",
       title = "IMDB Ratings by Elements of Avatar:\nThe Last Airbender",
  ...
  theme(panel.grid = element_blank(),
        plot.title = element_text(family = "Paprika",
                                  ...
                                  hjust = 0.5,
                                  margin = margin(b = 20)),
        axis.text.y = element_markdown(color = pal,
                                       family = "Paprika",
                                       size = 20,
                                       hjust = .12, 
                                       margin = margin(r = 10))) 

ggsave("W33_Avatar-TheLastAirbender.png", width = 32, height = 24, units = "cm")
```
