...
ggraph(graph_data, layout = "partition") +
  ...
  geom_image(data = filter(nodes, levels == 1), 
             ...
             size = 0.09, asp = 1.8) + 
  scale_color_manual(values = c("Africa" = "#fd6a02", 
                                "Asia" = "#f9d71c", 
                                "Europe" = "#0504aa", 
                                "North\nAmerica"= "#0cbb06", 
                                "South\nAmerica" = "#ff007f", 
  ...
  theme(legend.position = "none",
        panel.background = element_rect(fill = "#fffdfa",
                                        color = "transparent"),
        plot.title = element_markdown(color = "#2A363B", 
...
ggsave("W50_WomenOf2020.png", width = 65, height = 60, units = "cm")
