...
```{r}
global_mort <- read_csv("C:/Users/inkyscope/Documents/projectR/datavizRscope/2018/week3/data/global_mortality.csv")
```
...
ggsave("W3_GlobalMortality.png", width = 45, height = 28, units = "cm")
```
