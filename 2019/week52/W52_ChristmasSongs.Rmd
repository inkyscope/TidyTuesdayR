...
plot <- plot_data %>% 
  ...
  labs(x = "",
       ...
       subtitle = "Christmas ornaments(gold and silver) indicate that a song made the Billboard Top 100 by year.",
       caption = "Source: Billboard Top 100 | Graphic: Sung Inkyung") +
  theme_minimal() + 
  theme(plot.title = element_text(family = "Playfair Display", size = 30,
                              margin = margin(b = 10)),
    plot.subtitle = element_text(family = "Poppins", size = 17,
                                 margin = margin(b = 25)),
    plot.caption = element_text(family = "Poppins", size = 13,
                                 margin = margin(t = 20)),
    ...
    axis.text.y = element_text(family = "Playfair Display", size = 15, face = "bold"),
    axis.text.x = element_text(family = "Poppins", size = 15))

ggsave("W52_ChristmasSongsTop100.png", width = 45, height = 40, units = "cm")
