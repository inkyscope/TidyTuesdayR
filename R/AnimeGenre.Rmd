...
title <- ggplot(data.frame(x = 1:2, y = 1:10)) +
  labs(x = "",
       ...
       subtitle = "The highest coefficient anime genres of them all are *Shonen* and *Seinen*. *Shounen* is targeted for teenage <br> boys and *Seinen* toward young adult men. Image below is Dokgo Tak, a main character of Korean animated <br> film listed under *Shounen* and *Sports* genre. He has a rebellious spirit against social conventions and <br> refuses to give up and renew its commitment to overcoming difficulties. Its corresponding topics like <br> friendship, family are reflected in the word frequency plot from the synopsis of two genres.") +
