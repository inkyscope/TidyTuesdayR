...
ggsave(here("figures", "TopSavingCarJourney.png"), width = 13, height = 10, units = "in")
...
rank_plot <-  
  ...
  labs(x = "",
       ...
       subtitle = "It appears to be hard to set a default value for the pereference or purpose of \ncar buyers despite of cost saving advantage. Since it is a challenging task to \npull off a desired result.",
       caption = "source | fueleconomy.gov") +
