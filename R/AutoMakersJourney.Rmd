...
tol22rainbow= c("#771155", "#AA4488", "#CC99BB", "#114477", "#4477AA", "#77AADD", "#117777", "#44AAAA", "#77CCCC", "#117744", "#44AA77", "#88CCAA", "#777711", "#AAAA44", "#DDDD77", "#774411", "#AA7744", "#DDAA77", "#771122", "#AA4455", "#DD7788", "#525252")
...
top_save_plot <- top_save %>%
  ...
  labs(x = "",
       ...
       subtitle = "Suggesting headwinds and tailwinds against moving upward are displayed among automakers<br>since 1984. <span style='color:#44AA77'>**Jaguar**</span>, <span style = 'color:#DDDD77'>**Mercedez-Benz**</span> and<span style='color:#DDAA77'> **Porsche**</span> need a bold plan to shift.",
       caption = "source | fueleconomy.gov") +
  theme(panel.background = element_rect(fill = "#c4e2f3"),
        ...
        plot.title = element_textbox(color = "#1c1c39",
                                  size = 18,
                                  margin = margin(b = 10)),
...
ggsave(here("figures", "TopSavingCarJourney.png"), width = 10, height = 7, units = "in")
...
rank_plot <-  
  ...
  labs(x = "",
       ...
       subtitle = "It appears to be hard to set a default value for the pereference or purpose of<br>car buyers despite of cost saving advantage. Since it is a challenging task to<br>pull off a desired result.",
       caption = "source | fueleconomy.gov") +
...
ggsave(here("figures", "TopSavingRank.png"), width = 10, height = 7, units = "in")
