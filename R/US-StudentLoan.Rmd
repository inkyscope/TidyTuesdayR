...
p3 <- loans %>% 
  ...
  labs(x = "",
       y = "Amount of pyment",
       title = "US Student Loan Payment Types by quarter since 2015-Q4 ",
...
p4 <- loans %>% 
  ...
  labs(x = "",
       y = "",
       title = "The amount of <span style = 'color:#00ccff'>**payment**</span> vs the total outstanding <span style = 'color:#f74c05'>**loan**</span> every last quarter from 2015-Q4") +
  theme(plot.background = element_rect(fill = "transparent"),
        panel.background = element_rect(fill = "transparent"),
