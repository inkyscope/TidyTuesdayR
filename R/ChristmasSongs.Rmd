...
color_bells <- tibble(
  ...
  image = rep(c("C:/Users/inkyscope/Documents/projects/tidytuesday/image/green_ball.png", "C:/Users/inkyscope/Documents/projects/tidytuesday/image/red_ball.png"), length.out = length(unique(songs_2000$song)))
)
...
ggsave(here("figures", "ChristmasSongsTop100.png"), width = 14, height = 11, units = "in")
